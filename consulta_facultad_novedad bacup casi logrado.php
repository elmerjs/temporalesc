...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    ...
    if ($tipo_usuario == 1 && $action === 'aprobar_admin') {
        ...
        $sql_get_novedad = "SELECT novedad, fk_id_solicitud_original 
        ...
        if ($row_novedad = $result_novedad->fetch_assoc()) {
            ...
            elseif (in_array($novedad, ['Eliminar', 'Modificar']) && $fk_id_original) {
                ...
                elseif ($novedad === 'Modificar') {
                    ...
                    $stmt_update_orig->bind_param(
                        "ssddssssii",
                        $solicitud_wc['tipo_dedicacion'],
                        $solicitud_wc['tipo_dedicacion_r'],
                        $solicitud_wc['horas'],
                        $solicitud_wc['horas_r'],
                        $solicitud_wc['sede'],
                        $solicitud_wc['anexa_hv_docente_nuevo'],
                        $solicitud_wc['actualiza_hv_antiguo'],
                        $novedad,
                        $id,
                        $fk_id_original
                    );
